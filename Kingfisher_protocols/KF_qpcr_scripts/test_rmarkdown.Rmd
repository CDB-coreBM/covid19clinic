---
title: "Kingfisher results test 4"
...
raw_data <- read_delim("~/Documents/2020_05_08_RUN_PROVA4A_Presence%20Absence%20Result.csv", ",", escape_double = FALSE, trim_ws = TRUE, skip = 20)
...
kable(summary_table,format="html", escape= F)%>%
  ...
  add_header_above(c("Resultado" =1,'Número de targets' =4))
```
