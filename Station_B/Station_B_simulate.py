...
def run(ctx: protocol_api.ProtocolContext):
    ...
    STEPS = {
        ...
        3: {'Execute': True, 'description': 'Wait with magnet OFF'},
        ...
        15: {'Execute': True, 'description': 'Allow to dry'},
        16: {'Execute': True, 'description': 'Add water and LTA'},
        17: {'Execute': True, 'description': 'Wait with magnet OFF'},
        18: {'Execute': True, 'description': 'Wait with magnet ON'},
