...
data_A <- read_delim("/Users/covid19warriors/Documents/code/covid19clinic/tests/Kingfisher_pathogen_wetrun/KA_sample_setup_pathogen_time_log.txt", "\t", escape_double = FALSE, col_types = cols(execution_time = col_character()), trim_ws = TRUE)
...
ggsave('kingfisher_times_test_27042020_.png',plot=last_plot())
